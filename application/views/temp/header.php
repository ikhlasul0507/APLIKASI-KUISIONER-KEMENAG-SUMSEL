                    ...
                    <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <nav class="site-navigation d-flex justify-content-end align-items-center">
                            <ul class="d-flex flex-column flex-lg-row justify-content-lg-end align-items-center">
                                <li class="current-menu-item"><a href="<?= base_url();?>home">Beranda</a></li>
                                <li><a href="<?= base_url();?>tentang">Tentang Kami</a></li>
                                <li><a href="<?= base_url();?>hasil">Hasil</a></li>

                                <li class="call-btn button gradient-bg mt-3 mt-md-0">
                                    <a class="d-flex justify-content-center align-items-center" href="#"><img src="<?= base_url();?>assets/images/emergency-call.png">  0711- 351668</a>
                                </li>
                            </ul>
                        </nav><!-- .site-navigation -->
